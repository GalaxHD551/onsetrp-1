...
INSERT INTO `items` (`id`, `name`, `category`, `subcategory`, `price`, `weight`, `hunger`, `thirst`, `equipable`, `usable`) VALUES
	(NULL, 'water_bottle', 'miscellaneous', 'food', 10, 2000, 0, 30, 0, 1),
	(NULL, 'apple', 'miscellaneous', 'food', 25, 2000, 30, 0, 0, 1),
	(NULL, 'donut', 'miscellaneous', 'food', 30, 2000, 30, 0, 0, 1),
	(NULL, 'repair_kit', 'ironsmith', 'object', 300, 6000, 0, 0, 0, 1),
	(NULL, 'health_kit', 'miscellaneous', 'object', 150, 5000, 0, 0, 0, 1),
	(NULL, 'lockpick', 'ironsmith', 'object', 500, 4000, 0, 0, 0, 1),
	(NULL, 'pickaxe', 'ironsmith', 'tool', 60, 3000, 0, 0, 0, 1),
	(NULL, 'jerican', 'miscellaneous', 'object', 200, 8000, 0, 0, 0, 1),
	(NULL, 'phone', 'miscellaneous', 'object', 150, 2000, 0, 0, 0, 1),
	...
	(NULL, 'weed', 'drugs', 'object', 0, 2000, 0, 0, 0, 1),
